...
import com.capgebank.accounts.dto.AccountsContactInfoDto;
...
@Validated
@Tag(
        name = "CRUD REST APIs for Accounts in CapgeBank",
...
public class AccountController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account inside CapgeBank"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    public ResponseEntity<ResponseDto> updateAccount(@Valid @RequestBody CustomerDto customerDto) {
        ...
        if (isUpdated) {
            ...
            return ResponseEntity
                    ...
                    .body(new ResponseDto(AccountsConstants.STATUS_417, AccountsConstants.MESSAGE_STATUS_417));
        }
